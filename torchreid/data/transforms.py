...
class LetterBox(object):
    ...
    def __init__(self, new_shape=(640, 640), center=True):
    ...
    def __call__(self, img):
        ...
        # shape = img.shape[:2]  # current shape [height, width] #cv2
        # print("-----------------------------------------------------------", img.size)
        shape = [img.size[1], img.size[0]]  # current shape [height, width] #pil
